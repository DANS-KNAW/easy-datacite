/* end EASY hack
 * 
 *  rather adjust fileexplorer.changeNode to properly load node-info
 *  
 *  */
...
/**
  ...
  /**
    ...
    _onClickEvent: function (ev) {
    	...
    	/* EASY hack: do not collapse when label was clicked */
		if (/.*label.*/.test(td.id)) {
			toggle = function(force) {
				node.focus();
				if (force || !node.href) {
...
*/
  ...
  /**
    ...
    disableTreeview: function() {
    	var off_x = 0;
    	var off_y = 0;
    	var element=document.getElementById("pageInner");
    	while( element != null ){
    		off_x += element.offsetLeft;
    		off_y += element.offsetTop;
    	...
    	el=document.getElementById("folderTree");
    	var mask=document.getElementById("folderTree_mask");
    	mask.style.position="absolute";
    	mask.style.left=(x+1)+"px";
    	mask.style.top=(y+1)+"px";
    	mask.style.width=el.offsetWidth+"px";
    	mask.style.height=el.offsetHeight+"px";
    },
    
    enableTreeview: function() {
    	var mask=document.getElementById("folderTree_mask");
    	mask.style.position="absolute";
    	mask.style.left="0px";
    	mask.style.top="0px";
