...
class UserInfoForm extends AbstractEasyStatelessForm<EasyUser>
{
    ...
    public UserInfoForm(UserDetailsEditPanel userDetailsEditPanel, final String wicketId, final IModel<EasyUser> model, final FormListener listener)
    {
        ...
        add(new DropDownChoice<KeyValuePair>(UserProperties.DISCIPLINE1, new PropertyModel<KeyValuePair>(proxy, UserProperties.DISCIPLINE1), DisciplineUtils
                .getDisciplinesChoiceList().getChoices(), new KvpChoiceRenderer()).setNullValid(true));
        add(new DropDownChoice<KeyValuePair>(UserProperties.DISCIPLINE2, new PropertyModel<KeyValuePair>(proxy, UserProperties.DISCIPLINE2), DisciplineUtils
                .getDisciplinesChoiceList().getChoices(), new KvpChoiceRenderer()).setNullValid(true));
        add(new DropDownChoice<KeyValuePair>(UserProperties.DISCIPLINE3, new PropertyModel<KeyValuePair>(proxy, UserProperties.DISCIPLINE3), DisciplineUtils
                .getDisciplinesChoiceList().getChoices(), new KvpChoiceRenderer()).setNullValid(true));
