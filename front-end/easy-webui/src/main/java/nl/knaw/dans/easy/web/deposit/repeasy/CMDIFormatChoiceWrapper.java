...
public class CMDIFormatChoiceWrapper extends AbstractListWrapper<KeyValuePair> {
    ...
    /**
     * This method is called when the panel is displayed. When it is displayed we need to decide which of the radio options should be selected If the EASY
     * Metadata's DC Format contains the CMDI MIME-type, the YES option should be selected. In all other cases the NO option should be selected.
     */
    @Override
     ...
     * <p>
     * When the NO option (default) was selected we remove the CMDI MIME-type from the DC Format field in the EASY Metadata.
     */
    @Override
