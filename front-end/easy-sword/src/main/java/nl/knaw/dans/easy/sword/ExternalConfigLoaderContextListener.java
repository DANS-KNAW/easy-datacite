...
public class ExternalConfigLoaderContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        try {
            ...
            /*
             * This is a DRY-violation, because the name of the environment variable pointing to the home directory, EASY_SWORD_HOME, is also defined in
             ...
             * configure how Spring initialization is logged in $EASY_SWORD_HOME/cfg/logback.xml. Unless you see a better way to do this (and that doesn't make
            ...
            home.setEnvironmentVariableName("EASY_SWORD_HOME");
