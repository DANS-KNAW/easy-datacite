...
public class ITQLQueryFactory implements QueryFactory, Constants {
    ...
    /**
     * Convert the given Date to a String while also adding or subtracting a millisecond. The shift is necessary because the provided dates are inclusive,
     * whereas ITQL date operators are exclusive.
     */
