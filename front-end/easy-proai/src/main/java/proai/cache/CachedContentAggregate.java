...
public class CachedContentAggregate implements Writable {
    ...
    /**
     * Expects a file of the following form. line 0 - n : path [dateString if record or header] line n+1 : "end" or "end resumptionToken cursor" Note that if
     * dateString isn't given for a line in the file, it will be written as-is.
     */
    ...
    public void write(PrintWriter out) throws ServerException {
        ...
        try {
            ...
            out.println("<" + m_verb + ">");
            lineReader = new BufferedReader(new InputStreamReader(new FileInputStream(m_listFile), "UTF-8"));
            ...
            while (line != null) {
                ...
                if (line.startsWith("end")) {
                    ...
                    try {
                        ...
                        // is given as-is.
                        if (parts.length == 2) {
                            new CachedContent(m_cache.getFile(parts[0]), parts[1], headersOnly).write(out);
                        } else {
