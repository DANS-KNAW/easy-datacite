...
public class CachedContentAggregate implements Writable
{
    ...
    /**
     * Expects a file of the following form. line 0 - n : path [dateString if record or header] line n+1
     * : "end" or "end resumptionToken cursor" Note that if dateString isn't given for a line in the
     * file, it will be written as-is.
     */
