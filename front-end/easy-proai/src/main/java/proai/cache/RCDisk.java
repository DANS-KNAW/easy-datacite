...
public class RCDisk {
    ...
    /**
     * Get a new, unique path (relative to m_baseDir) for a file, based on the current time. If the directory for the path does not yet exist, it will be
     * created.
     */
    private String getNewPath() {
        ...
        synchronized (this) {
            ...
            while (now == _lastPathDate) {
                ...
                catch (Exception e) {} // make sure we have a unique date
    ...
    /**
     * Write the content of the given <code>Writable</code> to a new file and return the path of the file, relative to the disk cache base directory.
     */
