...
public class SessionManager extends Thread {
    ...
    /**
     * Get response data from the appropriate session and return it. The resumption token encodes the session id and part number. The first part is sessionid/0,
     * the second part is sessionid/1, and so on.
     */
