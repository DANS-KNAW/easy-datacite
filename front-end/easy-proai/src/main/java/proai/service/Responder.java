...
public class Responder
{
    ...
    public static final String PROP_INCOMPLETESETLISTSIZE = _PFX + "incompleteSetListSize";
    public static final String PROP_INCOMPLETERECORDLISTSIZE = _PFX + "incompleteRecordListSize";
    public static final String PROP_INCOMPLETEIDENTIFIERLISTSIZE = _PFX + "incompleteIdentifierListSize";
    ...
    public Responder(RecordCache cache, SessionManager sessionManager, int incompleteIdentifierListSize, int incompleteRecordListSize, int incompleteSetListSize)
            throws ServerException
    {
        init(cache, sessionManager, incompleteIdentifierListSize, incompleteRecordListSize, incompleteSetListSize);
    }

    private void init(RecordCache cache, SessionManager sessionManager, int incompleteIdentifierListSize, int incompleteRecordListSize,
     ...
     */
    public ResponseData getRecord(String identifier, String metadataPrefix) throws BadArgumentException, CannotDisseminateFormatException,
     ...
     * 
     * @param from
     *        optional UTC date specifying a lower bound for datestamp-based selective harvesting.
     * @param until
     ...
     *         if a low-level (non-protocol) error occurred.
     */
    public ResponseData listIdentifiers(String from, String until, String metadataPrefix, String set, String resumptionToken) throws BadArgumentException,
    ...
    private ResponseData listRecords(String from, String until, String metadataPrefix, String set, String resumptionToken, boolean identifiersOnly,
            int incompleteListSize) throws BadArgumentException, BadResumptionTokenException, CannotDisseminateFormatException, NoRecordsMatchException,
     ...
     *         if a low-level (non-protocol) error occurred.
     */
    public ResponseData listRecords(String from, String until, String metadataPrefix, String set, String resumptionToken) throws BadArgumentException,
            BadResumptionTokenException, CannotDisseminateFormatException, NoRecordsMatchException, NoSetHierarchyException, ServerException
    {
