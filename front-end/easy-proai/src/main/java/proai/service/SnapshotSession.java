...
public class SnapshotSession<T> extends Thread implements Session
{
    ...
    public void run()
    {
        ...
        try
        {
            ...
            m_manager.addSession(m_sessionKey, this); // after this point, we depend on the session
                                                      // manager to clean up
            ...
            while (iter.hasNext() && !m_threadNeedsToFinish)
            {
                ...
                out = new PrintWriter(new OutputStreamWriter(new FileOutputStream(partFile), "UTF-8"));
