...
public class CrosswalkHandler<T> extends DefaultHandler
{
    ...
    /**
     * Create a handler. It may receive control by the startElement of another instance and will return
     * control by the endElement at the same level.
     */
    ...
    /**
     * Creates the root handler. Assigns itself as ContentHandler to the reader passed into it. May
     * temporarily hand over control to subclasses or siblings as configured by the handlerMap.
     * 
     * @param target
     * @param reader
     * @param handlerMap
    ...
    /**
     * Receive notification of the end of any element treated by this handler. See the final
