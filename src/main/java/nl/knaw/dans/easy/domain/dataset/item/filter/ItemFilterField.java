...
public enum ItemFilterField
{
	...
	VISIBLETO(
		new Class[] { FileItemVO.class },
		VisibleToFieldFilter.class,
		"visibleTo",
		"visibleToList"),
	...
	@SuppressWarnings("unchecked")
	ItemFilterField(Class[] voTypes, Class<? extends ItemFieldFilter> fieldFilter, 
