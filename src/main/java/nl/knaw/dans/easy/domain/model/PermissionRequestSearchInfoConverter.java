...
public class PermissionRequestSearchInfoConverter implements
		SearchFieldConverter<List<PermissionRequestSearchInfo>>
{

	@SuppressWarnings("unchecked")
	public List<PermissionRequestSearchInfo> fromFieldValue(Object in)
			throws SearchBeanConverterException
	{
		List<String> inList;
	...
	public Object toFieldValue(List<PermissionRequestSearchInfo> in)
			throws SearchBeanConverterException
	{
