...
public class ChoiceListCache extends AbstractListCache<ChoiceList>
{
    ...
    //
    // /**
    // * Get a choice list as a Properties object. Properties inherit from HashTable and therefore the
    // sequence of choices
    ...
    // */
    // public Properties getProperties(String listId, Locale locale) throws IOException,
