...
public class DisciplineConverter extends SimpleXmlWriter {
	 ...
	 *             a discipline.
	 */
	public static String getDisciplineList(int recursionDepth)
			throws DomainException, ServiceException, RepositoryException {
		List<DisciplineContainer> disciplines = Services.getDisciplineService()
				.getRootDiscipline().getSubDisciplines();
	...
	public static String getDisciplineList(
			List<DisciplineContainer> disciplines, int recursionDepth)
			throws DomainException, ServiceException, RepositoryException {
	 ...
	 *             a discipline.
	 */
	public static String getDiscipline(DisciplineContainer discipline,
			int recursionDepth) throws DomainException, RepositoryException {
		...
		if (recursionDepth > 0) {
			List<DisciplineContainer> subDisciplines = discipline
					.getSubDisciplines();
