...
public class BusinessMocker
{
    ...
    /**
     * Creates an object to configure possible/expected behavior of the mocked services related to a
     * folder. The folder gets a generated {@link DmoStoreId}.
     * 
     * @param path
     ...
     *        of the the file within the dataset
     * @param dmoStoreId
     *        use the result of {@link #nextDmoStoreId(DmoNamespace)} with {@link FileItem#NAMESPACE} to
     *        avoid ID clashes with files created with {@link #file(String)}.
     * @return
     * @throws Exception
     */
     ...
     *        of the the folder within the dataset
     * @param dmoStoreId
     *        use the result of {@link #nextDmoStoreId(DmoNamespace)} with {@link FolderItem#NAMESPACE}
     *        to avoid ID clashes with folders created by {@link #folder(String)} or by folders
     *        implicitly created by {@link DatasetMocker#with(FileMocker...)}.
     * @return
     * @throws Exception
     */
