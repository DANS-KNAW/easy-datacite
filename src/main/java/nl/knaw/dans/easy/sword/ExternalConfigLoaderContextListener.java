...
public class ExternalConfigLoaderContextListener implements ServletContextListener
{
    ...
    public void contextInitialized(ServletContextEvent sce)
    {
        try
        {
             ...
             * directory, EASY_SWORD_HOME, is also defined in applicationContext.xml. However, we want to
             ...
             * $EASY_SWORD_HOME/cfg/logback.xml. Unless you see a better way to do this (and that doesn't
