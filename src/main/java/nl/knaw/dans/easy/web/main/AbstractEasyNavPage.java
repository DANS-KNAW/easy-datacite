...
public abstract class AbstractEasyNavPage extends AbstractEasyPage
{
     ...
     */
    public AbstractEasyNavPage(final PageParameters parameters)
    {
        super(parameters);
        init();
    }
     ...
     */
    public AbstractEasyNavPage(final IModel<?> model)
    {
        super(model);
        init();
    }
     ...
     */
    public AbstractEasyNavPage(final IPageMap map)
    {
        super(map);
        init();
    }
     ...
     */
    public AbstractEasyNavPage(final IPageMap map, final IModel<?> model)
    {
        super(map, model);
        init();
    }
     ...
     *        PageParameters
     */
    public AbstractEasyNavPage(final IPageMap pageMap, final PageParameters parameters)
    {
