...
public class InfoPage extends AbstractEasyNavPage
{
    ...
    /**
     * Allow HTML content to be set on the {@link InfoPage}. Use with caution! Use only if a hundred
     * percent sure that the {@link InfoPage} will not echo back user input, as that would introduce
