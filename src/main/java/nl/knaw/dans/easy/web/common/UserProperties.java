...
public interface UserProperties
{
    ...
    public static final String[] ALL_PROPERTIES = {USER_ID, DISPLAYNAME, TITLE, INITIALS, PREFIXES, SURNAME, ORGANIZATION, DEPARTMENT, FUNCTION,
            ADDRESS, POSTALCODE, CITY, COUNTRY, EMAIL, TELEPHONE, STATE, DISPLAYROLES, DISPLAYGROUPS, OPTS_FOR_NEWSLETTER, LOG_MY_ACTIONS, DAI};
