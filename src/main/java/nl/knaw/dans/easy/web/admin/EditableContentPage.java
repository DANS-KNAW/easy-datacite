...
public class EditableContentPage extends AbstractEasyNavPage {
	public EditableContentPage() {
		...
		addLink("updatePasswordMailHTML", "/mail/templates/authn/UpdatePasswordMail.html", user, new UpdatePasswordMessage(user, new ForgottenPasswordMessenger(null, "jan@jansen.com")));
		addLink("updatePasswordMailTXT", "/mail/templates/authn/UpdatePasswordMail.txt", user, new UpdatePasswordMessage(user, new ForgottenPasswordMessenger(null, "jan@jansen.com")));
		
		addLink("maintenanceNotificationMailHTML", "/mail/templates/maintenance/maintenaceNotification.html", user, dataset, new MaintenanceNotification(dataset));
		...
		addLink("depositConfirmationHTML", "/mail/templates/deposit/depositConfirmation.html", user, dataset, datasetSubmission, new SubmitNotification(datasetSubmission));
		addLink("depositConfirmationTXT", "/mail/templates/deposit/depositConfirmation.txt", user, dataset, datasetSubmission, new SubmitNotification(datasetSubmission));
		
		addLink("depositConfirmationOtherAccessHTML", "/mail/templates/deposit/depositConfirmationOtherAccess.html", user, dataset, datasetSubmission, new SubmitNotification(datasetSubmission));
		addLink("depositConfirmationOtherAccessTXT", "/mail/templates/deposit/depositConfirmationOtherAccess.txt", user, dataset, datasetSubmission, new SubmitNotification(datasetSubmission));
		
		addLink("newDepositorNotificationHTML", "/mail/templates/deposit/newDepositorNotification.html", user, dataset, new NewDepositorNotification(dataset, user, user));
		addLink("newDepositorNotificationTXT", "/mail/templates/deposit/newDepositorNotification.txt", user, dataset, new NewDepositorNotification(dataset, user, user));
		
		addLink("oldDepositorNotificationHTML", "/mail/templates/deposit/oldDepositorNotification.html", user, dataset, new OldDepositorNotification(dataset, user, user));
		addLink("oldDepositorNotificationTXT", "/mail/templates/deposit/oldDepositorNotification.txt", user, dataset, new OldDepositorNotification(dataset, user, user));
		...
		addLink("deniedReplyNotificationHTML", "/mail/templates/permission/DeniedReplyNotification.html", user, dataset, new ReplyNotification(dataset, new PermissionSequenceImpl(user), prm));
		addLink("deniedReplyNotificationTXT", "/mail/templates/permission/DeniedReplyNotification.txt", user, dataset, new ReplyNotification(dataset, new PermissionSequenceImpl(user), prm));
		
		addLink("grantedReplyNotificationHTML", "/mail/templates/permission/GrantedReplyNotification.html", user, dataset, new ReplyNotification(dataset, new PermissionSequenceImpl(user), prm));
		addLink("grantedReplyNotificationTXT", "/mail/templates/permission/GrantedReplyNotification.txt", user, dataset, new ReplyNotification(dataset, new PermissionSequenceImpl(user), prm));
		
		addLink("requestNotificationHTML", "/mail/templates/permission/requestNotification.html", user, dataset, new RequestNotification(dataset, user, new PermissionRequestModel()));
		addLink("requestNotificationTXT", "/mail/templates/permission/requestNotification.txt", user, dataset, new RequestNotification(dataset, user, new PermissionRequestModel()));
	
		addLink("returnedReplyNotificationHTML", "/mail/templates/permission/ReturnedReplyNotification.html", user, dataset, new ReplyNotification(dataset, new PermissionSequenceImpl(user), prm));
		addLink("returnedReplyNotificationTXT", "/mail/templates/permission/ReturnedReplyNotification.txt", user, dataset, new ReplyNotification(dataset, new PermissionSequenceImpl(user), prm));
