...
public class NamePanel extends Panel
{
    ...
    public NamePanel(final String name, final IModel<ITreeItem> model, final AbstractTree<ITreeItem> tree, final DatasetModel datasetModel,
            final SelectableFolderContent content, final boolean hasAdditionalLicense, final AjaxLink<Void> fileActionLink) throws ServiceRuntimeException,
            ServiceException
    {
        super(name, model);
