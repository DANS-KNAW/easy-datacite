...
public class UserDetailsEditPanel extends AbstractEasyPanel implements EasyResources
{
    ...
    {
        UserInfoForm infoForm = new UserInfoForm(WI_USER_INFO_FORM, (IModel<EasyUser>) getDefaultModel(), listener);
        add(infoForm);
    ...
    class UserInfoForm extends AbstractEasyStatelessForm<EasyUser>
    {
        ...
        public UserInfoForm(final String wicketId, final IModel<EasyUser> model, final FormListener listener)
        {
            ...
            SubmitLink updateButton = new SubmitLink(UPDATE_BUTTON, new ResourceModel(buttonLabel));
            add(updateButton);
    ...
    private List<String> getGroupIds()
    {
        ...
        try
        {
            groups = Services.getUserService().getAllGroupIds();
        }
        catch (ServiceException e)
        {
