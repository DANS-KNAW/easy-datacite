        ...
        return new LoadableDetachableModel<String>()
        {
            ...
            protected String load()
            {
                if (SystemStatus.INSTANCE.getReadOnly())
                    return getLocalizer().getString("adminSwitch.readOnly", AbstractEasyNavPage2.this, "[SYSTEM IS IN READ ONLY MODE]");
                else
                    return getLocalizer().getString("adminSwitch.readWrite", AbstractEasyNavPage2.this, "[system allows read and write]");
            }
        };
    }
