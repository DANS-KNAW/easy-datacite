...
@RequireHttps
public class UsersOverviewPage2 extends AbstractEasyNavPage2 implements EasyResources
{
    private static final String WI_USER_OVERVIEW_PANEL = "userOverviewPanel2";

    private static final Logger logger = LoggerFactory.getLogger(UsersOverviewPage.class);

    public UsersOverviewPage2()
    {
        super();
        ...
        add(new UsersOverviewPanel2(WI_USER_OVERVIEW_PANEL, getDefaultModel()));
