...
public class RelationPanel extends AbstractChoicePanel<RelationModel>
{
    ...
    class RepeatingEditModePanel extends Panel
    {
        ...
        RepeatingEditModePanel(final ListItem item)
        {
            ...
            final DropDownChoice relationTypeChoice = new DropDownChoice("relationTypeChoice", new PropertyModel(item
                    .getDefaultModelObject(), "relationType"), getChoiceList().getChoices(), getRenderer());
            ...
            final TextField subjectTitleField = new TextField("subjectTitleField", new PropertyModel(item.getDefaultModelObject(),
                    "subjectTitle"));

            final TextField subjectLinkField = new TextField("subjectLinkField", new PropertyModel(item.getDefaultModelObject(),
                    "subjectLink"));
            ...
            add(new VerifyUrlPanel("verifyPopup", "relation.url.verify.label", "#subjectTitle", currRelItemPath + ":"
                    + this.getId() + ":" + subjectLinkField.getPageRelativePath()));
