...
public class FederativeAuthenticationResultPage extends AbstractEasyNavPage
{
        ...
        else
        {
            ...
            if (retievedFederativeUserId != null)
            {
                ...
                catch (ObjectNotAvailableException e)
                {
                    ...
                    // create a mapping with an existing account which requires login into easy using
                    // passwd
            ...
            {
                // no fedId should not happen unless this page was requested without Shibboleth
                // redirect!!!
    ...
    {
        couplingLink = new Link<String>("couplingLink", new PropertyModel(this, "federativeUserId")) // ,
                                                                                                     // FederativeToEasyUserAccountCouplingPage.class)
        {
            private static final long serialVersionUID = 1L;
