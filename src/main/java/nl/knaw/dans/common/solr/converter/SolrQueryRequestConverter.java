...
public class SolrQueryRequestConverter
{
	...
	private static String fieldQueryToString(Field<?> fieldQuery)
			throws NullPointerFieldException
	{
		...
		String queryStringValuePart = (fieldValue instanceof SearchQuery ?
