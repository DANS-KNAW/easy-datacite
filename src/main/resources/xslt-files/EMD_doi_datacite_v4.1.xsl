...
<xsl:stylesheet
    ...
    <!--
        Changes from v4.xsl:
        * IsSourceOf -> HasVersion
        * IsSupplementTo -> IsRequiredBy
        * IsDerivedFrom -> IsVersionOf
        * IsSupplementedBy -> Requires
        * @nameType attribute in creator/contributor
    -->
    <!-- ==================================================== -->
    ...
    <xsl:template name="metadata-root">
        <xsl:element name="resource">
            ...
            <!-- datacite version 4.1, previous version was 4 -->
            <xsl:attribute name="xsi:schemaLocation" select="'http://datacite.org/schema/kernel-4 http://schema.datacite.org/meta/kernel-4.1/metadata.xsd'"/>
    ...
    <!-- no use of attribute nameType possible. This is not a problem, as there won't be an identifier either -->
    <!-- ==================================================== -->
    ...
    <xsl:template match="eas:hasVersion[eas:subject-link != '']">
        <xsl:call-template name="relatedIdentifier">
            <xsl:with-param name="link" select="eas:subject-link/text()"/>
            <xsl:with-param name="relationType" select="'HasVersion'"/> 
        </xsl:call-template>
    </xsl:template>
    ...
    <xsl:template match="eas:isRequiredBy[eas:subject-link != '']">
        <xsl:call-template name="relatedIdentifier">
            <xsl:with-param name="link" select="eas:subject-link/text()"/>
            <xsl:with-param name="relationType" select="'IsRequiredBy'"/> 
        </xsl:call-template>
    </xsl:template>
    ...
    <xsl:template match="eas:isVersionOf[eas:subject-link != '']">
        <xsl:call-template name="relatedIdentifier">
            <xsl:with-param name="link" select="eas:subject-link/text()"/>
            <xsl:with-param name="relationType" select="'IsVersionOf'"/> 
        </xsl:call-template>
    </xsl:template>
    ...
    <xsl:template match="eas:requires[eas:subject-link != '']">
        <xsl:call-template name="relatedIdentifier">
            <xsl:with-param name="link" select="eas:subject-link/text()"/>
            <xsl:with-param name="relationType" select="'Requires'"/> 
        </xsl:call-template>
    </xsl:template>
