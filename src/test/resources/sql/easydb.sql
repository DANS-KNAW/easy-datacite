...
WITHOUT OIDS;
ALTER TABLE easy_files OWNER TO easyadmin;
...
WITHOUT OIDS;
ALTER TABLE easy_folders OWNER TO easyadmin;
...
WITHOUT OIDS;
ALTER TABLE easy_folder_creator OWNER TO easyadmin;
...
WITHOUT OIDS;
ALTER TABLE easy_folder_visibility_status OWNER TO easyadmin;
...
WITHOUT OIDS;
ALTER TABLE easy_folder_accessibility_status OWNER TO easyadmin;
