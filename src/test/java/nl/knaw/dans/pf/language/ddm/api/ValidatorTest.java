...
//        System.err.println(handler.getMessages());
        ...
        Source s1 = new StreamSource(
                new URL("http://easy.dans.knaw.nl/schemas/md/2012/11/ddm.xsd").openStream());
        Source s2 = new StreamSource(
                new URL("http://easy.dans.knaw.nl/schemas/dcx/2012/10/dcx-gml.xsd").openStream());
