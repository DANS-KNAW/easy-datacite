...
public final class SchemaCacheTest
{
    ...
    {
        URL url = this.getClass().getClassLoader().getResource("test-files/validation/minimal.xsd");
    ...
    {
        SchemaCache.getSchema(this.getClass().getClassLoader().getResource("test-files/validation/invalid.xsd"));
    }
