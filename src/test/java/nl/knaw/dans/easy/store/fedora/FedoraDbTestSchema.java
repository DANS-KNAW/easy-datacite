...
public class FedoraDbTestSchema
{
	...
	{
		DbLocalConfig localConfig = new DbLocalConfig("sa", "",
				"jdbc:log:org.hsqldb.jdbcDriver:hsqldb:mem:easyfedoradb", "net.rkbloom.logdriver.LogDriver",
	...
	{
		 SchemaExport schema = new
         SchemaExport(DbUtil.getConfiguration());
