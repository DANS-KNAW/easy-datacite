...
public class SearchHitConverterTest {
	...
	public void emptyConversion() {
		String xml = SearchHitConverter
				.convert(new ArrayList<SimpleSearchHit<?>>());
	...
	public void normalConversion() {
		...
		String normalHit = "<hit>" + "<title>title</title>"
				+ "<storeId>easy-dataset:1</storeId>"
				+ "<creator>creator</creator>"
				+ "<dateCreated>13-13-13</dateCreated>"
				+ "<description>description</description>"
				+ "<identifier>identifier</identifier>"
				+ "<coverage>coverage</coverage>"
				+ "<accessCategory>OPEN_ACCESS</accessCategory>" + "</hit>";
		String nullHit = "<hit>" + "<title>title</title>"
				+ "<storeId>easy-dataset:1</storeId>"
				+ "<creator>creator</creator>"
				+ "<dateCreated>13-13-13</dateCreated>"
				+ "<accessCategory>OPEN_ACCESS</accessCategory>" + "</hit>";
		String expectedXml = "<hits>" + normalHit + normalHit + nullHit
				+ "</hits>";
		assertEquals(expectedXml, xml);
	}
