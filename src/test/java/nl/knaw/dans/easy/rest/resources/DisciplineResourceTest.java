...
public class DisciplineResourceTest extends RestTest {
	...
	@Test
	public void getAllDisciplines() throws ServiceException,
	...
	@Test
	public void getAllDisciplinesNotFound() throws ObjectNotFoundException,
			ServiceException {
	...
	private void setUpException(Class<? extends Throwable> t)
		...
		when(disciplineServiceMock.getDisciplineById(isA(DmoStoreId.class)))
				.thenThrow(t);
	}
	...
	@Test
	public void getAllDisciplinesDomainProblem()
			throws ObjectNotFoundException, ServiceException {
	...
	@Test
	public void getAllDisciplinesServiceProblem()
			throws ObjectNotFoundException, ServiceException {
	...
	@Test
	public void getAllDisciplinesRepositoryProblem()
			throws ObjectNotFoundException, ServiceException {
	...
	@Test
	public void getRootDisciplines() throws ServiceException,
			RepositoryException, DomainException {
		setUpDisciplines();
	...
	@Test
	public void getRootDisciplinesNotFound()
			throws ObjectNotFoundException, ServiceException {
		setUpException(ObjectNotFoundException.class);
	...
	@Test
	public void getRootDisciplinesDomainProblem()
			throws ObjectNotFoundException, ServiceException {
		setUpException(DomainException.class);
	...
	@Test
	public void getRootDisciplinesServiceProblem()
			throws ObjectNotFoundException, ServiceException {
		setUpException(ServiceException.class);
	...
	@Test
	public void getRootDisciplinesRepositoryProblem()
			throws ObjectNotFoundException, ServiceException {
		setUpException(RepositoryException.class);
	...
	private void setUpGetDisciplineById() throws ServiceException,
			DomainException {
		List<DisciplineContainer> rootChildren = new ArrayList<DisciplineContainer>();
		rootDiscipline = mock(DisciplineContainer.class);
		when(rootDiscipline.getSubDisciplines()).thenReturn(rootChildren);
		when(disciplineServiceMock.getDisciplineById(isA(DmoStoreId.class)))
				.thenReturn(rootDiscipline);
	}

	@Test
	public void getDisciplineBySidNotFound() throws ServiceException,
			DomainException {
		setUpException(ObjectNotFoundException.class);
	...
	@Test
	public void getDisciplineBySidServiceProblem() throws ServiceException,
			DomainException {
		setUpException(ServiceException.class);
	...
	@Test
	public void getDisciplineBySidDomainProblem() throws ServiceException,
			DomainException {
		setUpException(DomainException.class);
	...
	@Test
	public void getDisciplineBySidRepositoryProblem() throws ServiceException,
			DomainException {
		setUpException(RepositoryException.class);
	...
	@Test
	public void getSubDisciplinesNotFound() throws ObjectNotFoundException,
			ServiceException {
		setUpException(ObjectNotFoundException.class);
	...
	@Test
	public void getSubDisciplinesServiceProblem() throws ObjectNotFoundException,
			ServiceException {
		setUpException(ServiceException.class);
	...
	@Test
	public void getSubDisciplinesDomainProblem() throws ObjectNotFoundException,
			ServiceException {
		setUpException(DomainException.class);
	...
	@Test
	public void getSubDisciplinesRepositoryProblem() throws ObjectNotFoundException,
			ServiceException {
		setUpException(RepositoryException.class);
