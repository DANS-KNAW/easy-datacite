...
public class FileTreeResourceTest extends RestTest {
	...
	@Test
	public void getTreeRoots() throws ObjectNotAvailableException,
			CommonSecurityException, ServiceException {
		setUpServiceMethods();

		WebResource resource = resource().path(
				"dataset/easy-dataset:1/filetree");
	...
	@Test
	public void getTreeRootsNotFound() throws ObjectNotAvailableException,
			CommonSecurityException, ServiceException {
	...
	@Test
	public void getTreeRootsNotAuthorized() throws ObjectNotAvailableException,
			CommonSecurityException, ServiceException {
	...
	@Test
	public void getTreeRootsInternalServerError()
			throws ObjectNotAvailableException, CommonSecurityException,
			ServiceException {
	...
	@Test
	public void getFolderSubTree() throws ObjectNotAvailableException,
			CommonSecurityException, ServiceException {
		setUpServiceMethods();

		WebResource resource = resource().path(
				"dataset/easy-dataset:1/filetree/easy-folder:1");
		ClientResponse response = resource.get(ClientResponse.class);
	...
	@Test
	public void getFolderSubTreeNotFound()
			throws ObjectNotAvailableException, CommonSecurityException,
			ServiceException {
		setUpException(ObjectNotAvailableException.class);
	...
	@Test
	public void getFolderSubTreeNotAuthorized()
			throws ObjectNotAvailableException, CommonSecurityException,
			ServiceException {
		setUpException(CommonSecurityException.class);
	...
	@Test
	public void getFolderSubTreeInternalServerError()
			throws ObjectNotAvailableException, CommonSecurityException,
			ServiceException {
		setUpException(ServiceException.class);
