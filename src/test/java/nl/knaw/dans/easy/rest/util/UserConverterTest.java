...
public class UserConverterTest {
	...
	public void conversion() {
		...
		String expectedXml = "<account>" +
				...
				"<primaryDiscipline>primaryDiscipline</primaryDiscipline>" +
				"<secondaryDiscipline>secondaryDiscipline</secondaryDiscipline>" +
				"<tertiaryDiscipline>tertiaryDiscipline</tertiaryDiscipline>" +
