...
public class HighlightedCharSequenceSubSequenceTest
{
    ...
    public static Collection<Object[]> parameters()
    {
        return Arrays.asList(new Object[][] {
                ...
                {"012345",  1, 6, "12345"}, 
                {"012345", 0, 5, "01234"}, 
                {"<em>012345</em>", 0, 6, "<em>012345</em>"}, 
                {"<em>012345</em>",  1, 6, "<em>12345</em>"},
                {"<em>012345</em>", 0, 5, "<em>01234</em>"}, 
                {"012<em>3</em>45", 2, 4, "2<em>3</em>"}, 
                {"012<em>34</em>56", 2, 4, "2<em>3</em>"}, 
                {"<em>012</em>3<em>45</em>", 2, 5, "<em>2</em>3<em>4</em>"},
