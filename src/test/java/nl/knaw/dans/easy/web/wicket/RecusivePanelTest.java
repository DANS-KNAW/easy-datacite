...
// }
//
// /** Converts HTML rendered by Wicket with iText to a section of the license PDF (issues issues #203,
// #175, #141) */
// private void proofOfConcept(final String renderedHtml) throws LicenseComposerException,
...
// }
//
// private static TestPanelSource createRecursivePanel(final MetadataFormat metadataFormat, final boolean
// editable)
// {
...
// }
//
// private static FormPage getFormPage(final MetadataFormat metadataFormat, final boolean editable)
...
// depoDiscipline.getEmdFormDescriptor().getFormDefinition(DepositDiscipline.EMD_VIEW_DEFINITION);
