...
//
// /**
// * An independent environment with mocked objects injected into services. This super test class
// provides helper methods to create variants of the mocked
// * objects. The default mocked objects concentrate on a session user and a dataset and are geared to
// test components on the dataset view page. The environment
...
// * </pre>
// *
// * To overrule a method call prepared for some mocked object, overrule all prepared method calls, like
// for example:
// *
// * <pre>
...
// * </pre>
// *
// * The tester resulting from one of the two snippets above provides assertion methods. Further
// development of tests may require to implement more expect and
// * helper methods.
// *
// * @author Joke Pol
// */
...
// /** TODO if all implement Mockable, could "Mockable[] allMocks = {}" be used for resetMocks and
// replayMocks ?? */
// private static Object[] allMocks = {mockedDataset, mockedSessionUser, mockedFileStoreAccess,
// mockedDisciplineCollection, mockedAuthz,
// mockedEasyStore };
//
...
// {
// final String[] fileNames = {"folder1/fileA.txt", "folder1/fileB.txt", "folder2/fileX.txt",
// "folder2/fileY.txt"};
// final String datasetStoreId = "easy-dataset:123";
//
// expect(mockedFileStoreAccess.getFilenames(datasetStoreId,
// true)).andReturn(Arrays.asList(fileNames)).anyTimes();
//
...
// }
//
// protected static void expectDiscipline(final String disciplineName, final String disciplineId) throws
// Exception
// {
//
...
// {
// reset(mockedDatasetService, mockedDataset, mockedSessionUser, mockedFileStoreAccess,
// mockedDisciplineCollection, mockedAuthz, mockedEasyStore);
// }
//
// protected static void replayMocks()
// {
// replay(mockedDatasetService, mockedDataset, mockedSessionUser, mockedFileStoreAccess,
// mockedDisciplineCollection, mockedAuthz, mockedEasyStore);
// }
//
...
//
// /**
// * Captures and validates the rendered HTML code for a panel. Wrapper for {@link #captureHtml(String,
// int, int)}.
// *
// * @param panel
// * see {@link WicketTester#startPanel(TestPanelSource)}
// */
// protected final String captureHtmlOf(final TestPanelSource panel, final String filename, final int
// expectedWarnings, final int expectedErrors)
// throws IOException
// {
...
// */
// protected final String captureHtmlOf(final ITestPageSource page, final String filename, final int
// expectedWarnings, final int expectedErrors)
// throws IOException
// {
...
//
// /**
// * Captures and validates the rendered HTML code for a component after a call to {@link
// #getWicketTester()}.start...
// *
// * @param filename
// * the rendered HTML code is written to {@link #captureFolder}/filename for debugging purposes
// * @param expectedWarnings
// * the expected value for {@link HtmlValidator#warningCount()}. If negative the number of warnings is
// not validated.
// * @param expectedErrors
// * the expected value for {@link HtmlValidator#errorCount()}. If negative the number of errors is not
// validated.
// * @return the rendered and cleaned up HTML code.
// * @throws IOException
// * if writing the rendered HTML code fails.
// */
// public String captureHtml(final String filename, final int expectedWarnings, final int expectedErrors)
// throws IOException
// {
...
// }
//
// protected void writeHtml(final String filename, final String document) throws FileNotFoundException,
// IOException
// {
...
//
// /**
// * Primary objective: validation; side effect: cleaned up HTML code. Warnings and errors are written to
...
// * @return
// */
// private String validateHtml(final int expectedWarnings, final int expectedErrors, final String
// rendered)
// {
...
//
// final String stripped = rendered.replaceAll("<.?wicket:[^>]*>", "").replaceAll("wicket:id=.[^\"]*\"",
// "").replaceAll("xmlns:wicket=.[^\"]*\"", "");
...
// }
//
// protected static EasyMetadataImpl getMetadata(final String location) throws ResourceNotFoundException,
