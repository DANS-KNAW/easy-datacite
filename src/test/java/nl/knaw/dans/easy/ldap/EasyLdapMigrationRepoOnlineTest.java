...
public class EasyLdapMigrationRepoOnlineTest extends AbstractOnlineTest
{
    ...
    public void add_update_delete() throws Exception
    {
        ...
        IdMap idm1 = new IdMap("easy-dataset:123", 
                "twips.dans.knaw.nl--7354684735049108415-1167745265100",
                "urn:nbn:nl:ui:13-9hp-3ap",
                migrationDate);
        ...
        IdMap idm3 = new IdMap("easy-dataset:123", 
                "twips.dans.knaw.nl--anders",
                "ook anders",
                newMigrationDate);
    ...
    private String insertSecond(String aipId, String persistentIdentifier) throws RepositoryException, ObjectExistsException
    {
        ...
        IdMap idm2 = new IdMap("easy-dataset:124", 
                aipId,
                persistentIdentifier,
                migrationDate2);
