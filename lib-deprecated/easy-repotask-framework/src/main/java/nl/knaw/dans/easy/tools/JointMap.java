...
public class JointMap {
    ...
    public static final String DMO_STORE_ID = "dmoStoreID";
    ...
    public void setDmoStoreId(DmoStoreId dmoStoreId) {
        put(DMO_STORE_ID, dmoStoreId);
    }

    public DmoStoreId getDmoStoreId() {
        return (DmoStoreId) get(DMO_STORE_ID);
    }
