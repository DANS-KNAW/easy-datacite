...
/**
 * A subtree handles all children of a single node (or the root nodes if a <code>null</code> node was given to the constructor).
 * 
...
public class Subtree<T> extends Panel {
    ...
    /**
     * Create a subtree for the children of the node contained in the given model or the root nodes if the model contains <code>null</code>.
     * 
     * @param id
     *        component id
     * @param tree
