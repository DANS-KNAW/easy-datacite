...
/**
 * This class adds a checkbox to a {@link Folder}. Subclasses have to override {@link #newCheckBoxModel(IModel)} to do anything useful with the checkbox state.
 * 
...
public class CheckedFolder<T> extends Folder<T> {
    ...
    /**
     * Hook method to create a new checkbox component. This default implementation uses an {@link AjaxCheckBox}.
     * 
     * @param id
     * @param model
