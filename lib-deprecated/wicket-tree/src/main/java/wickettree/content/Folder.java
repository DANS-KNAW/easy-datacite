...
/**
 * A typical folder representation of nodes in a tree. The link is used to expand/collapse the tree depending on the {@link State} of the current node. Nodes
 * without children are not clickable. Subclasses may change this behavior by overriding {@link #isClickable()} and {@link #onClick(AjaxRequestTarget)}.
 * 
 * @author Sven Meier
 */
