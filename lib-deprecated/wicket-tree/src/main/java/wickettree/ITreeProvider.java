...
/**
 * Provider of a tree. You can use the {@link IDetachable#detach()} method for cleaning up your ITreeProvider instance.
 * 
 * @see IDetachable
 * @see AbstractTree
 * @author Sven Meier
...
public interface ITreeProvider<T> extends IDetachable {
    ...
    /**
     * Does the given object have children - note that this method may return <code>true</code> even if {@link #getChildren(Object)} returns an empty iterator.
     */
    ...
    /**
     * Callback used by the consumer of this tree provider to wrap objects retrieved from {@link #getRoots()} or {@link #getChildren(Object)} with a model
     * (usually a detachable one). <br>
