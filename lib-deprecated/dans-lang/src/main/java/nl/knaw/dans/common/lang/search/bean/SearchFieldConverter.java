...
/**
 * A search field converter converts from and to a field value. The field value is gotten from and saved into the search index. It currently depends on the
