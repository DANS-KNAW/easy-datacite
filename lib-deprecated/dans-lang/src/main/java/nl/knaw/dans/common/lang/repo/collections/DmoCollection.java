 ...
 * relationship are in the context of a filesystem, while nodes in a treeview are in the context of a
 * treeview. This object annotates this type of relations. Thus this object may be used to store
 * information on whether this relation is hierarchical, how many of a certain type of object may contain
 * other types of objects, etc. Currently it implements just one feature that makes sure that
 * container-items of one type of collection cannot be inserted into the containers of another type of
 * collection.
 * 
 * @author lobo
 */
