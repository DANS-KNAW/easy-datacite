...
/**
 * The DANS ontology. Currently I am not sure how we should use this, 
 * how and if we should map on existing standard, but at least here we 
 * can define our own ontology if needed. 
 * 
 * @author lobo
 */
public class DansOntologyNamespace extends OntologyNamespace
{
     ...
     * prepare for update and replaced with DmoContainerItemRelations Parents or something!
     * Anyway. If you add a relation of this type, than it is gone before update is actually processed.
     * It's time to get rid of this stupid DmoContainerItemRelations shit.
     * (If ever Lodewijk gets into my hands I'll .....)
     */
