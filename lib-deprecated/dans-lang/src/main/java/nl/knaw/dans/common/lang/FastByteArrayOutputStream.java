...
/**
 * http://javatechniques.com/blog/faster-deep-copies-of-java-objects/ ByteArrayOutputStream implementation that doesn't synchronize methods and doesn't copy the
 * data on toByteArray().
 */
