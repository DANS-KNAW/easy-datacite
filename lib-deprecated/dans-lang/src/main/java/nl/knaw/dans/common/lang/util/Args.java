...
/**
 * A utility class for creating consistent arguments in the format <code>name=value</code>. This class can be used either for reading or writing arguments.
 */
public class Args implements Serializable {
    ...
    /**
     * Construct a read only Args from the given String array. If the String array contains the key <code>"prop.file.name"</code> the properties file at the
     * given location will also be loaded.
     * 
     * @param args
     *        String array
