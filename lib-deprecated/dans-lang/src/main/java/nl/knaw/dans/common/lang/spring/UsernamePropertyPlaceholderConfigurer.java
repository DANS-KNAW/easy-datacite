...
/**
 * User name dependent PropertyPlaceholderConfigurer. This class looks for a property file <b>on the classpath</b> under the name
 * conf/app/[user.name].properties, where [user.name] is defined by the value of the System property 'user.name'. If no user-specific file is found, this class
 * uses the property file under conf/app/application.properties.
 * 
