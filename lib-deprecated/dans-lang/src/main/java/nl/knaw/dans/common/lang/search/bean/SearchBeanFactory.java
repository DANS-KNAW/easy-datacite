...
/**
 * The search bean factory is responsible for the creation of search bean based on an document coming from the search index. The factory also is able to return
 * the right search bean converter for a class for the reverse process.
 * 
 * @author lobo
 */
