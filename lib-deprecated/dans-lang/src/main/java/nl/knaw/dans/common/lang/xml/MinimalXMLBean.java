...
/**
 * Minimal XML bean is an object that can return an XML representation of itself. It is minimal in that sense that is has only the one method that is needed to
 * accomplish that goal. For a richer interface see XMLBean
 * 
 * @see XMLBean
