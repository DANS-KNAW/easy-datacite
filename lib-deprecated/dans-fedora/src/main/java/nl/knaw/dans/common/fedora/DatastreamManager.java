...
public class DatastreamManager
{
     ...
     * @param controlGroup
     *        the control group of the datastream, one of {@link ControlGroup#E} or
     *        {@link ControlGroup#R}
     * @param dsState
    ...
    /**
     * Creates a new datastream in the object - only for Externally Referenced or Redirected Content. The
     * {@link Datastream} should at least have one {@link DatastreamVersion} . The DatastreamVersion
     * should at least have one {@link ContentLocation}. Only the first DatastreamVersion is added.
     * <p/>
    ...
    /**
     * Creates a new datastream in the object. This method takes an {@link InputStream} as carrier for
     * the content. The input stream is closed after this method has done with it.
     * 
     * @param sid
     *        The sid of the object
     * @param streamId
    ...
    /**
     * Creates a new datastream in the object. This method takes a {@link File} as carrier for the
     * content.
     * 
     * @param sid
     *        The sid of the object
    ...
    /**
     * Creates a new datastream in the object. This method takes a {@link MinimalXMLBean} as carrier for
     * the content.
     * 
     * @param sid
     *        The sid of the object
     ...
     *        The datastream ID
     * @param versionDate
     *        A dateTime indicating the version of the datastream to verify. If null, Fedora will use the
     *        most recent version.
     ...
     *        The datastream ID
     * @param versionDate
     *        The date/time stamp specifying the desired version of the object. If null, the current
     *        version of the object (the most recent time) is assumed.
     * @return fedora.server.types.gen.Datastream
     *         <ul>
     *         <li>DatastreamControlGroup controlGroup - String restricted to the values of "X", "M",
     *         "R", or "E" (InlineXML,Managed Content,Redirect, or External Referenced).</li>
     ...
     *         <li>long size - The size of the datastream in Fedora. Not the size of any referenced
     *         contents, but only the fedora stored xml.</li>
     *         <li>String state - The state of the datastream. Will be "A" (active), "I" (inactive) or
     *         "D" (deleted).</li>
     *         <li>String location - If the datastream is an external reference or redirect, the url to
     *         the contents.</li>
     *         <li>String checksumType - The algorithm used to compute the checksum. One of "DEFAULT",
     *         "DISABLED", "MD5", "SHA-1", "SHA-256", "SHA-385", "SHA-512", "HAVAL", "TIGER",
     *         "WHIRLPOOL".</li>
    ...
    /**
     * Change the referenced location for a datastream. This operation is only relevant for managed,
     ...
     *        Location of managed, redirect, or external referenced datastream content
     * @param contentDigestType
     *        The algorithm used to compute the checksum. One of "DEFAULT", "DISABLED", "MD5", "SHA-1",
     *        "SHA-256", "SHA-385", "SHA-512", "HAVAL", "TIGER", "WHIRLPOOL".
     * @param checksum
     ...
     * redirect or external reference datastreams (controlgroup E,M,R).
     * 
     * @see #modifyDatastreamByReference(String, String, String[], String, String, String, String,
     *      String, String, String, boolean)
     * @see DatastreamVersion#setContentLocation(ContentLocation)
     * @see DatastreamVersion#setContentLocation(nl.knaw.dans.common.fedora.fox.ContentLocation.Type,
     *      java.net.URI)
     * @param sid
     *        the sid of the object
     * @param version
    ...
    /**
     * Modifies an existing Datastream in an object, by value. This operation is only valid for Inline
     * XML Datastreams (i.e. controlGroup "X").
     * 
     * @param sid
     *        the sid of the object
     * @param streamId
     ...
     * XML Datastreams (i.e. controlGroup "X").
     * 
     * @see #modifyDatastreamByValue(String, String, String[], String, String, String, byte[], String,
    ...
    /**
     * Modifies an existing Datastream in an object, by value. This operation is only valid for Inline
     * XML Datastreams (i.e. controlGroup "X"). This method uses {@link TimestampedMinimalXMLBean} as the
     * carrier of the content.
     * 
     * @param sid
     *        the sid of the object
     * @param streamId
     ...
     *         if the timestamp of the TimestampedObject is older than the last registered modification
     *         of the datastream in the object
     * @throws RepositoryException
     *         as the common base class for checked exceptions
     */
    ...
    /**
     * Modifies an existing Datastream in an object, by value. This operation is only valid for Inline
     * XML Datastreams (i.e. controlGroup "X"). This method uses a TimestampedObject and a byte array as
    ...
    /**
     * Selectively turn versioning on or off for selected datastream. When versioning is disabled,
     * subsequent modifications to the datastream replace the current datastream contents and no
     * versioning history is preserved. To put it another way: No new datastream versions will be made,
     * but all the existing versions will be retained. All changes to the datastream will be to the
     * current version.
     * 
     * @param sid
     *        the sid of the object
     ...
     *        The datastream ID
     * @param startDT
     *        The (inclusive) start date-time stamp of the range. If null, this is taken to be the lowest
     *        possible value, and thus, the entire version history up to the endDT be purged.
     * @param endDT
     *        The (inclusive) ending date-time stamp of the range. If null, this is taken to be the
     *        greatest possible value, and thus, the entire version history back to the startDT will be
     *        purged.
     * @param force
     *        Force the update even if it would break a data contract
     * @param logMessage
