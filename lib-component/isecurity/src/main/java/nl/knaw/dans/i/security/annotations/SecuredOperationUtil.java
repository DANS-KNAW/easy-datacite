...
{
    /**
     * List the securityIds of operations declared in the given interface, that have the annotation
     * {@link SecuredOperation}.
     * 
     * @param _interface
    ...
    /**
     * List the securityIds of operations in the given <code>implementation</code> class, that are
     * implementations of operations declared in (one of) its interface(s) where both declarations have
     * the annotation {@link SecuredOperation}.
     * <p/>
     * If the given <code>implementation</code> class is itself an interface and the returned list
     * contains items, than this is an indication that an operation is declared more than once in the
     * hierarchy and that both declarations have the annotation {@link SecuredOperation}. This should not
     * happen, as it undermines the uniqueness of the securityId.
     * 
    ...
    /**
     * List the securityIds of operations in the given <code>implementation</code> class, that are
     * implementations of operations declared in the given <code>_interface</code> class, where both
     * declarations have the annotation {@link SecuredOperation}.
     * 
     * @param _interface
     ...
     * <li>id of {@link SecuredOperation} annotation of implementing class method is consistent with
     * interface method;</li>
     * <li>{@link SecuredOperation} annotation on implementing class method is absent in implemented
     * interface(s);</li>
     * <li>all {@link SecuredOperation} annotations on interface methods are present on implementing
     * class methods.</li>
     * </ul>
     * 
     * @param _class
     ...
     *         if {@link SecuredOperation} annotations are not valid, or not consistent with interface
     *         hierarchy of the given implementing class.
     */
