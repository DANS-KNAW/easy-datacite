...
object CommandLineOptions {
  def parse(args: Array[String]): Settings = {
    ...
    val username: String = opts.username.toOption.getOrElse(askUsername(url.toString))
    val password: String = opts.password.toOption.getOrElse(askPassword(username,url.toString))
