...
Upload.prototype.init = function()
{
    ...
    this.progressMessageContainer = document.createElement('div');
    this.progressMessageContainer.className = "alert alert-dismissible alert-info";
    ...
    this.cancelButton.className = "btn btn-danger btn-xs pull-right"; // "upload-cancel-link"
    ...
    this.progressContainer.appendChild(this.progressMessageContainer);
    this.progressMessageContainer.appendChild(this.progressMessage);
    this.progressMessageContainer.appendChild(this.cancelButton);
...
{
    this.progressMessageContainer.className = "alert alert-dismissible alert-danger";
...
Upload.prototype.updateStatus = function(uploadStatus)
{
    ...
    if (uploadStatus.finished)
    {
         ...
         */
        this.progressMessageContainer.className = "alert alert-dismissible alert-success"
        if (uploadStatus.message)
...
{
    this.cancelButton.innerHTML = "&times;";
    this.cancelButton.className = "close";
