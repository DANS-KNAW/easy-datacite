...
/**
 * A search criterium is an object that can apply changes to a search request. Search criteria are the primary way of updating the search request. The search
 * criteria are made displayable by the SearchCriteriaPanel.
 * 
...
public interface SearchCriterium extends Serializable {
    /**
     * @return a string model that is used by the CriteriaPanel for displaying a link or label text belonging to this criterium.
     */
