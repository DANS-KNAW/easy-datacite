...
/**
 * Example usage in the wicket application init() With the effect that every string resource not for Locale.ENGLISH will be surrounded by {} This us useful for
 * testing if strings are loaded on a Locale settings change for the application while having the 'normal' strings for a 'standard' locale
 * 
 * <pre>
