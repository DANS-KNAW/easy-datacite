...
/**
 * Extending this class gives the extender access to common Wicket methods. It is recommended that users
 * of the Dans Commons wicket use the CommonPanel or the CommonGPanel as a base class for all Wicket
 * panels.
 * 
 * @author lobo
 */
