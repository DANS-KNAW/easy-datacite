...
/**
 * Simple interface to translate an original value according to a locale. A translator model might also do the trick and may be more elegant, but I've already
 * done it like this..
 * 
 * @author lobo
 * @param <T>
