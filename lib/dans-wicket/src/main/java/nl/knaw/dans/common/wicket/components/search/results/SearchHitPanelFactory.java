...
/**
 * The search hit panel factory is responsible for creating the hit panels that display one search hit. By implementing this factory one may choose to use
 * different panels for different search hit objects.
 * 
 * @author lobo
 */
