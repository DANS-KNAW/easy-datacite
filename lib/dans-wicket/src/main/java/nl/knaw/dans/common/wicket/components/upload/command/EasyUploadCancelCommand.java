...
/**
 * @author lobo Called by browser when an upload process needs to be canceled. Currently this class does not return anything. For the moment it can safely be
 *         assumed canceling the process goes well.
 */
