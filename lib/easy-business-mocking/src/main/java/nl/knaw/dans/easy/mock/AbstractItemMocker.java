...
class AbstractItemMocker<VO extends AbstractItemVO, I extends DatasetItem> {
    ...
    /**
     * Creates mocked instances of a file or folder. A fluent interface allows further configuration of possible/expected behavior of the objects, and how
     * {@link EasyStore} and {@link ItemService} treat them.
     */
     ...
     * mocked {@link DatasetItem} with any value for the other arguments.<br/>
     * Remember to override corresponding method calls of {@link FileStoreAccess} set by {@link DatasetMocker}. Both the calls expected before as after the
     * purge. Otherwise the default stubs give the items an eternal life.
     * 
