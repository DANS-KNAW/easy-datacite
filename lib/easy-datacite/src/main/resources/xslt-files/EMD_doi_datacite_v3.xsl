...
<xsl:stylesheet 
    ...
    <xsl:template name="metadata-root">
        <xsl:element name="resource">
            ...
            <!-- datacite version 3, previous version was 2.2 -->
            <xsl:attribute name="xsi:schemaLocation" select="'http://datacite.org/schema/kernel-3 http://schema.datacite.org/meta/kernel-3/metadata.xsd'"/>
