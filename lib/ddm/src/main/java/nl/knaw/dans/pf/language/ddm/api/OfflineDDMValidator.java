...
/**
 * DDM validation normally uses the online schemas at "http://easy.dans.knaw.nl/schemas/", but for testing we want to use the schema files locally at
 * "../../schema/" For the files note that schema is without an s! Note that the schema files are in this easy-app module and therefore the OfflineDDMValidator
 * does not work from outside this module.
 * 
 * @author paulboon
 */
public class OfflineDDMValidator extends AbstractValidator2 {
    ...
    final static String LOCAL_SCHEMA_DIR = "target/easy-schema/";
