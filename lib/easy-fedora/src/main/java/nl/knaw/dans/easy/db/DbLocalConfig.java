...
/**
 * Local config of the database, meaning the config that is changeable per
 * instance of the software. Global config is written in the hibernate config
...
public class DbLocalConfig {
	...
	public DbLocalConfig(String username, String password,
			String connectionUrl, String hbnDriverClass, String hbnDialect) {
		this(username, password, connectionUrl, hbnDriverClass, hbnDialect,
				true);
	}
	...
	public void configure(Configuration config) {
		...
		config.setProperty("hibernate.cache.use_second_level_cache",
				Boolean.toString(useCache));
		config.setProperty("hibernate.cache.use_query_cache",
				Boolean.toString(useCache));
	}
