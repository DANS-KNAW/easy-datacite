...
/**
 * Signals that a serialized object normally retrievable by an identifier from a deserializing agent unexpectantly is unknown to or unfindable for the
 * deserializing agent. This is a RuntimeException so it should be used with care.
 * 
