...
public interface ItemFieldFilter<FIELD> extends ItemFilter {
    ...
    /**
     * Tells if this item needs to be filtered out (removed from the list). This method cannot be placed on the ItemFilter interface, since it might be possible
     * to write an ItemFilter that filters out items based on information of more than one item.
     * 
     * @param item
