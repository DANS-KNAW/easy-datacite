...
/**
 * Service for {@link DepositDiscipline}s. Each Discipline obtained from this service is guaranteed to have a {@link FormDefinition} with an id
 * {@link DepositDiscipline#EMD_DEPOSITFORM_WIZARD}.
 * 
 * @author ecco
 */
