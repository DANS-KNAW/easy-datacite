...
/**
 * Signals that the data layer is inaccessible. This is a runtime exception so it should be used with care. This exception should only be used under well known
 * conditions, where a failure to access the data layer can only be caused by a failing connection exception or other technical causes.
 * 
