...
public class ContextParameters implements Serializable {
    ...
    /**
     * Construct new ContextParameters. The second -optional- parameter of this constructor takes an array of objects. The fist {@link Dataset} thrown in is
     * retrievable by {@link #getDataset()}. The first {@link FileItem} can be retrieved by {@link #getFileItem()}. The first {@link EasyUser} in the array can
     * be obtained by {@link #getUserUnderEdit()}. Other objects in the array are stored under their implementation class name and can be recalled by
    ...
    /**
     * Set the result of a method. Could be used by a security aspect to add the result of a method to this context and with this context get the advise of a
     * SecurityOfficer.
     * 
     * @param result
    ...
    /**
     * Retrieve an object that was thrown in at construction time. (The fist {@link Dataset} thrown in is retrievable by {@link #getDataset()}. The first
     * {@link EasyUser} in the array can be obtained by {@link #getUserUnderEdit()}.)
     * 
     * @param clazz
     *        the implementation class of the object
     * @param index
     *        the index of the object on a per class-basis
     * @return object thrown in at construction time or <code>null</code> if no object of the given class at the per-class-index is available
     */
