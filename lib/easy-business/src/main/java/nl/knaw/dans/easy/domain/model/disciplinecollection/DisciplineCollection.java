...
public interface DisciplineCollection {
     ...
     * @throws ObjectNotFoundException
     *         thrown when no discipline could be found with this sid
     * @throws DomainException
     *         wrapper exception
     */
    ...
    /**
     * Case insensitive search for a discipline by name. The name is the default English name.
     * 
     * @param disciplineName
     *        the name to search for
     * @return the found discipline object
     * @throws ObjectNotFoundException
     *         thrown when no discipline could be found with this particular name
     * @throws DomainException
     *         wrapper exception
     */
