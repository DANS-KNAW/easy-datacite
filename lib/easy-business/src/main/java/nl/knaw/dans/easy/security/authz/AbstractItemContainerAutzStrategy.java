...
public abstract class AbstractItemContainerAutzStrategy extends AbstractDatasetAutzStrategy {

    private static final long serialVersionUID = 1L;
    protected static Logger logger = LoggerFactory.getLogger(AbstractItemContainerAutzStrategy.class);
    private int discoveryProfile = NOT_EVALUATED;
    private int readProfile = NOT_EVALUATED;

    public AbstractItemContainerAutzStrategy(final User user, final Object... contextObjects) {
        super(user, contextObjects);
    }

    public AbstractItemContainerAutzStrategy() {
        super();
    }
