...
public interface DatasetService extends EasyService {
    ...
    /**
     * Get the Dataset with the given id. If the parameter <code>storeId == null</code> a new (empty) Dataset will be returned.
     * 
     * @param sessionUser
    ...
    /**
     * Save the EasyMetadata unit of the dataset. Note there is a potential security hazard in the implementation, because any component of the dataset that has
    ...
    /**
     * Save the AdministrativeMetadata unit of the dataset. Note there is a potential security hazard in the implementation, because any component of the
     * dataset that has changed will be saved.
     * 
     * @param sessionUser
     *        the user that initiates this action
     * @param dataset
