...
public class ExternalConfigLoaderContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        try {
            ...
            /*
             * This is a DRY-violation, because the name of the environment variable pointing to the home directory, EASY_SOS_HOME, is also defined in
             ...
             * configure how Spring initialization is logged in $EASY_SOS_HOME/cfg/logback.xml. Unless you see a better way to do this (and that doesn't make it
             * necessary to configure logging in multiple places), please leave this small DRY-violation in place.
             */
            EnvironmentVariableBasedHomeDirectory home = new EnvironmentVariableBasedHomeDirectory();
            home.setEnvironmentVariableName("EASY_SOS_HOME");
